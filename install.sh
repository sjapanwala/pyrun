...
if ! command -v python3 &> /dev/null; then
    ...
    echo -e "\033[90mcmooon, didnt you read that python was part of the app?\033[0m"
    ...
    exit 1
        ...
        if [ $? -eq 0 ]; then
            #echo "Downloading Python script from $PYTHON_SCRIPT_URL..."
                ...
                if ! [ $? -eq 0 ]; then
                    ...
                    if [[ "$answer" =~ ^[Yy]$ ]]; then
                        ...
                        if [ $? -eq 0 ]; then
                            ...
                            echo -e "\033[91Error Occurred!... This time IDK what happened\033[0m"
                            exit 1
                        fi
                    else
                        echo -e "\033[91mInstallation Aborted\033[0m"
